from telethon.errors.rpcerrorlist import UserDeactivatedBanError, PeerFloodError
...
if __name__ == "__main__":
    ...
    parser.add_argument("--login", action=argparse.BooleanOptionalAction, default=False, help="Instead of starting the application, log in.")
    parser.add_argument("--new", action=argparse.BooleanOptionalAction, default=False, help="Instead of starting the application, sign up.")
